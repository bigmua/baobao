let heartWidth = window.screen.width
if (heartWidth > 450) {
    heartWidth = 450
}
...
$(function () {
    ...
    // 计算love days
    let days = Math.floor((Date.now()  - new Date("2022-5-28 19:00:00"))/(60*60*24*1000))  + 1
    $("#loveDays span").text(days)
